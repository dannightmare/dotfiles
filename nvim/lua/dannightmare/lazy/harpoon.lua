return {
    ...
    dependencies = { "nvim-lua/plenary.nvim" },
        config = function()
            ...
            vim.keymap.set("n", "<leader><C-g>", function() harpoon:list():replace_at(1) end)
            vim.keymap.set("n", "<leader><C-h>", function() harpoon:list():replace_at(2) end)
            vim.keymap.set("n", "<leader><C-j>", function() harpoon:list():replace_at(3) end)
            vim.keymap.set("n", "<leader><C-k>", function() harpoon:list():replace_at(4) end)
        end
}
